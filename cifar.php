      ...
      <div id="gallery">
        <div class="outerframe">
          <div class="innerframe">
            <a href="#proj-image"><img src="images/cifar1.png" alt="" /></a>
          </div>
        </div>

        <div class="outerframe">
          <div class="innerframe">
            <a href="#turtle-code"><img src="images/cifar2.png" alt="" /></a>
          </div>
        </div>
        <div class="outerframe">
          <div class="innerframe">
            <a href="#pong-game"><img src="images/cifar3.png" alt="" /></a>
          </div>
        </div>
        <div class="outerframe">
          <div class="innerframe">
            <a href="#python-logo"><img src="images/cifar4.png" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
