      ...
      <div id="gallery">
        <div class="outerframe">
          <div class="innerframe">
            <a href="#proj-image"><img src="images/dbms1.png" alt="" /></a>
          </div>
        </div>

        <div class="outerframe">
          <div class="innerframe">
            <a href="#turtle-code"><img src="images/dbms2.png" alt="" /></a>
          </div>
        </div>
        <div class="outerframe">
          <div class="innerframe">
            <a href="#pong-game"><img src="images/dbms3.png" alt="" /></a>
          </div>
        </div>
        <div class="outerframe">
          <div class="innerframe">
            <a href="#python-logo"><img src="images/dbms4.png" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
